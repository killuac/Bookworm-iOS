...
#define TIP_CACHE_CLEAR_DONE            LocalizedString(@"CacheClearDone", @"缓存已清除")
#define TIP_CLEARING_CACHE              LocalizedString(@"ClearingCache", @"正在清除缓存...")
#define TIP_CONNECTION_TIMEOUT          LocalizedString(@"ConnectionTimeout", @"网络异常，请稍后再试")
#define TIP_NO_CONNECTION               LocalizedString(@"NoNetworkConnection", @"似乎已断开与互联网的连接")
#define TIP_NETWORK_UNSTABLE            LocalizedString(@"NetworkUnstable", @"你当前的网络不稳定，请切换网络。")
#define TIP_MOBILE_INVALID              LocalizedString(@"MobileInvalid", @"手机号码无效")
#define TIP_MOBILE_TAKEN                LocalizedString(@"MobileTaken", @"手机号码已经被注册")
#define TIP_MOBILE_NOT_FOUND            LocalizedString(@"MobileNotFound", @"手机号码尚未注册")
#define TIP_EMAIL_INVALID               LocalizedString(@"EmailInvalid", @"邮箱地址无效")
#define TIP_EMAIL_TAKEN                 LocalizedString(@"EmailTaken", @"邮箱已经被注册")
#define TIP_EMAIL_TOO_LONG              LocalizedString(@"EmailTooLong", @"邮箱长度不能大于32位")
#define TIP_EMAIL_NOT_FOUND             LocalizedString(@"EmailNotFound", @"邮箱尚未注册")
#define TIP_PASSWORD_WRONG              LocalizedString(@"PasswordWrong", @"密码错误")
#define TIP_PASSWORD_TOO_SHORT          LocalizedString(@"PasswordTooShort", @"密码长度不能小于6位")
#define TIP_PASSWORD_INVALID            LocalizedString(@"PasswordInvalid", @"密码含有非法字符")
#define TIP_SMS_CODE_WRONG              LocalizedString(@"SMSCodeWrong", @"验证码错误")
#define TIP_NICKNAME_WRONG              LocalizedString(@"NicknameWrong", @"请输入正确的昵称")
#define TIP_ASK_FOR_SIGN_OUT            LocalizedString(@"AskForSignOut", @"确定退出登录？")
#define TIP_ACCESS_PHOTOS_SETTING       LocalizedString(@"AccessPhotosSetting", @"请在手机的“设置-隐私-照片”选项中，允许听画访问你的手机相册。")
#define TIP_ACCESS_CAMERA_SETTING       LocalizedString(@"AccessCameraSetting", @"请在手机的“设置-隐私-相机”选项中，允许听画访问你的手机相机。")
#define TIP_ACCESS_MICROPHONE_SETTING   LocalizedString(@"AccessMicrophoneSetting", @"请在手机的“设置-隐私-麦克风”选项中，允许听画访问你的麦克风。")
#define TIP_SIGNING_IN                  LocalizedString(@"SigningIn", @"登录中...")
#define TIP_CREATING_USER               LocalizedString(@"CreatingUser", @"账号创建中...")
#define TIP_THANKS_FEEDBACK             LocalizedString(@"ThanksFeedback", @"感谢你对“书虫”的支持")
#define TIP_REPORT_SUCCESS              LocalizedString(@"ReportSuccess", @"举报成功")
#define TIP_SINGLE_TAP_REFRESH          LocalizedString(@"SingleTapRefresh", @"点击屏幕重新加载")
#define TIP_USER_KICK_OUT               LocalizedString(@"UserKickOut", @"账号已在其他设备登录，请重新登录。")
