...
#define BUTTON_TITLE_REPLY              LocalizedString(@"Reply", @"回复")
#define BUTTON_TITLE_ACCEPT             LocalizedString(@"Accept", @"同意")
#define BUTTON_TITLE_REJECT             LocalizedString(@"Reject", @"拒绝")
...
#define TITLE_PHOTOS                    LocalizedString(@"Photos", @"照片")
#define TITLE_CAMERA                    LocalizedString(@"Camera", @"相机")
#define TITLE_MICROPHONE                LocalizedString(@"Microphone", @"麦克风")
...
#define MSG_ACCESS_PHOTOS_SETTING       LocalizedString(@"AccessPhotosSetting", @"请在系统的“设置-隐私-照片”选项中，允许”书虫“访问你的照片。")
#define MSG_ACCESS_CAMERA_SETTING       LocalizedString(@"AccessCameraSetting", @"请在系统的“设置-隐私-相机”选项中，允许”书虫“访问你的相机。")
#define MSG_ACCESS_MICROPHONE_SETTING   LocalizedString(@"AccessMicrophoneSetting", @"请在系统的“设置-隐私-麦克风”选项中，允许”书虫“访问你的麦克风。")
...
#define MSG_APP_VERSION_UNAVAILABLE     LocalizedString(@"AppVersionUnavailable", @"应用版本过低，请到App Store更新。")
