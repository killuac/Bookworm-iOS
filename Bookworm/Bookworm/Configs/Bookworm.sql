...
CREATE TABLE IF NOT EXISTS Outbox (guid INTEGER PRIMARY KEY AUTOINCREMENT, messageID INTEGER, sender TEXT NOT NULL, receiver TEXT NOT NULL, content TEXT NOT NULL, timestamp INTEGER NOT NULL, isSending BOOLEAN DEFAULT 0);
